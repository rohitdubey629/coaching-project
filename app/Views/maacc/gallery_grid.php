...
<body id="bg">
	<div class="page-wraper">
		...
		echo view('maacc/layout/header.php'); ?>
													...
													<div class="dlab-thum dlab-img-overlay1 ">
														...
														<div class="overlay-bx">
															<div class="overlay-icon">
																<span data-exthumbimage="<?php echo base_url() ?>uploads/gallery_grid/<?php echo $value['img1'] ?>" data-src="<?php echo base_url() ?>uploads/gallery_grid/<?php echo $value['img1'] ?>" class="check-km" title="<?php echo $value['title'] ?>">
