                ...
                <div class="main-bar clearfix ">
                    <div class="container clearfix">
                        ...
                        <div class="logo-header mostion">
                            <a href="<?php echo base_url('home/');?>" class="dez-page"><img src="<?php echo base_url('assets/')?>images/logo.png" alt=""></a>
                        </div>
                        <!-- nav toggle button -->
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="#">Our Gallery <i class="fa fa-chevron-down"></i></a>
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="<?php echo base_url('gallery_filter')?>">Gallery Tiles Filter</a></li>
                                    </ul>
                                </li>
