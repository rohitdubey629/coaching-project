                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <button type="button" class="btn  btn-primary" onclick="addHomeScrollbar();">Add Testimonial</button>
                            </div>
                                            ...
                                            if (!empty($testimonial)) {
                                                foreach ($testimonial as $key => $value) { ?>
                                                    <tr class="table-warning">
                                                        ...
                                                        <td><img src="<?php echo base_url(); ?>uploads/testimonials/<?php echo $value['img1']; ?>" style="height:100px; width:100;"></td>
                                ...
                                <div class="col-sm-12" id="imageFeedback">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="invalid-feedback" style="display:block;">Image Width and Height should be 120*120</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function addHomeScrollbar() {
        $("#heading_title").html("Add Testimonial");
        $("#heading").modal("show");
    ...
    function updateHomeSlider(id) {
        ...
        $("#heading_title").html("Update Testimonial")
        $("#heading").modal("show");
        $("#btn-heading").html("Update")
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('updateTestimonial') ?>",
            data: {
                id: id
            },
            dataType: "json",
            ...
            if ((file = this.files[0])) {
                ...
                img.onload = function() {
                    ...
                    if (width >= "120" && height == "120") {
                        ...
                        Swal.fire({
                            title: "error!",
                            text: "Invalid Widht And Height Image width and heigth should be 120*120",
                            icon: "error",
    ...
    $(document).ready(function() {
        $("#homescrollbarfrm").submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('addTestimonial') ?>",
