                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <button type="button" class="btn  btn-primary" onclick="addHomeScrollbar();">Add Home Slider</button>
                            </div>
                                            ...
                                            if (!empty($homeSlider)) {
                                                foreach ($homeSlider as $key => $value) { ?>
                                                    <tr class="table-warning">
                                                        ...
                                                        <td><img src="<?php echo base_url(); ?>uploads/home_slider/<?php echo $value['img1']; ?>" style="height:100px; width:100;"></td>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="home-heading" name="heading" required maxlength="40">
                                </div>
                            </div>
                            <div class="col-sm-12 col-lg-12">
                                <div class="form-group">
                                    <label class="floating-label">Content</label>
                                    <textarea class="form-control" id="home-content" name="content" required maxlength="75"> </textarea>
                                </div>
                            </div>
            ...
            if ((file = this.files[0])) {
                ...
                img.onload = function() {
                    ...
                    if (width >= "1920" && height == "800") {
                        ...
                        Swal.fire({
                            title: "error!",
                            text: "Invalid Widht And Height Image width and heigth should be 1920*1067",
                            icon: "error",
