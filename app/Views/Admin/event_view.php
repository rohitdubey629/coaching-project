                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <button type="button" class="btn  btn-primary" onclick="addHomeScrollbar();">Add News/Event</button>
                            </div>
...
<script>
    ...
    function addHomeScrollbar() {
        $("#heading_title").html("Add News/Event");
        $("#heading").modal("show");
    ...
    function updateHomeSlider(id) {
        ...
        $("#heading_title").html("Update News/Event")
        $("#heading").modal("show");
        $("#btn-heading").html("Update")
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('updateEvent') ?>",
            data: {
                id: id
            },
            dataType: "json",
