                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <button type="button" class="btn  btn-primary" onclick="addHomeScrollbar();">Add Gallery grid</button>
                            </div>
                                            ...
                                            if (!empty($homeSlider)) {
                                                foreach ($homeSlider as $key => $value) { ?>
                                                    <tr class="table-warning">
                                                        ...
                                                        <td><img src="<?php echo base_url(); ?>uploads/gallery_grid/<?php echo $value['img1']; ?>" style="height:100px; width:100;"></td>
...
<script>
    ...
    function addHomeScrollbar() {
        $("#heading_title").html("Add Gallery Grid");
        $("#heading").modal("show");
    ...
    function updateHomeSlider(id) {
        ...
        $("#heading_title").html("Update Gallery Grid")
        $("#heading").modal("show");
        $("#btn-heading").html("Update")
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('updateGalleryGrid') ?>",
            data: {
                id: id
            },
            dataType: "json",
            ...
            if ((file = this.files[0])) {
                ...
                img.onload = function() {
                    ...
                    if (width >= "600" && height == "472") {
                        ...
                        Swal.fire({
                            title: "error!",
                            text: "Invalid Widht And Height Image width and heigth should be 600*427",
                            icon: "error",
    ...
    $(document).ready(function() {
        $("#galleryGridFrm").submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('addGalleryGrid') ?>",
