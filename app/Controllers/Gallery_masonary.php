...
class Gallery_masonary extends BaseController
{
    ...
    public function index()
    {
        ...
        $table = "gallery_masonary";
        if ($session->get('is_login')) {
            $data['homeSlider'] = $contactModel->get_data($table);

            return view('Admin/gallery_masonary_view', $data);
        } else {
    ...
    public function addGalleryMasonary()
    {
                        ...
                        if ($imagefile->isValid()) {
                            ...
                            if (in_array($imagefile->getClientExtension(), $ext)) {
                                ...
                                if (!empty($imagename)) {
                                    ...
                                    if (file_exists("uploads/gallery_masonary/" . $imagename)) {
                                        unlink("uploads/gallery_masonary/" . $imagename);
                                    }
                                }
                                $newName = $imagefile->getRandomName();
                                $imagefile->move('uploads/gallery_masonary', $newName);
    ...
    public function updateGalleryMasonary()
    {
