...
class Testimonial extends BaseController
{
    ...
    public function index()
    {
        ...
        if ($session->get('is_login')) {
            ...
            $data['testimonial'] = $contactModel->get_data("testimonial");

            return view('Admin/testimonial_view', $data);
        } else {
        ...
        if ($session->get('is_login')) {
            ...
            if (!empty($this->request->getpost('heading_id'))) {
                        ...
                        if ($imagefile->isValid()) {
                            ...
                            if (in_array($imagefile->getClientExtension(), $ext)) {
                                ...
                                if (!empty($imagename)) {
                                    ...
                                    if (file_exists("uploads/testimonials/" . $imagename)) {
                                        unlink("uploads/testimonials/" . $imagename);
                                    }
                                }
                                $newName = $imagefile->getRandomName();
                                $imagefile->move('uploads/testimonials', $newName);
                ...
                if ($chk_img_file) {
                    ...
                    $record['year'] =  $this->request->getpost('year');
