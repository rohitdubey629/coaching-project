...
class Admin_faqs extends BaseController
{

    public function index()
    {
        $session = \Config\Services::session();
        $faqsEnquiry = new Data_model();
        $table = "faqs_enquiry";
        if ($session->get('is_login')) {

            $data['faqs_enquiry'] = $faqsEnquiry->get_data($table);
    ...
    public function filterData()
    {
        ...
        $html = "";
        $filter_data = $faqsEnquiry->getfaqsRecord($table, $custom_data);
